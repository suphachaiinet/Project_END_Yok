...
# สร้าง Blueprint สำหรับ Lab 10
lab10_bp = Blueprint('lab10', __name__)

# โฟลเดอร์เก็บไฟล์เฉลย (config) ของ lab10
...
scores_collection = db['lab10_scores']  # แยก Collection สำหรับ Lab 2
...
def check_config_lab10():
    ...
    # อ่านค่าที่ถูกต้องจากไฟล์ (อยู่ใน check_config/lab10_sw1.txt, lab10_pc1.txt)
    correct_switch_config = read_config_file('lab10_sw1.txt')
    correct_pc_config = read_config_file('lab10_pc1.txt')
